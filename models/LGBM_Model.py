...
class LGBM_Model(Base_Model):
    ...
    def plot_feature_importance(self):
        ...
        imp_df['gain'] = self.model.feature_importance()
    ...
    def train_model(self, train_set, val_set = None):
        ...
        if val_set:
            ...
            return lgb.train(self.params, train_set, valid_sets=[train_set], verbose_eval=verbosity)

    def get_params(self):
        return self.params
    
    def convert_dataset(self, x_train, y_train):
        train_set = lgb.Dataset(x_train, y_train, categorical_feature=self.categoricals, free_raw_data=False)
        return train_set
    ...
    def fit(self):
        ...
        self.params['n_estimators'] = int(model.best_iteration * 1.1)
